...
@.str.1 = private unnamed_addr constant [22 x i8] c"Handle Game Physics!!\00", align 1
@.str.2 = private unnamed_addr constant [11 x i8] c"Logo State\00", align 1
@.str.3 = private unnamed_addr constant [12 x i8] c"Title State\00", align 1
@.str.4 = private unnamed_addr constant [11 x i8] c"Game State\00", align 1
@.str.5 = private unnamed_addr constant [15 x i8] c"GameOver State\00", align 1
@.str.6 = private unnamed_addr constant [14 x i8] c"Credits State\00", align 1
@.str.7 = private unnamed_addr constant [12 x i8] c"Pause State\00", align 1
...
; Function Attrs: nounwind ssp uwtable
define void @game.handle_physics() #0 !dbg !38 {
entry:
  %x = alloca %"char[]", align 8
  %out = alloca ptr, align 8
  %x1 = alloca %"char[]", align 8
  ...
  %error_var5 = alloca i64, align 8
  %error_var11 = alloca i64, align 8
  store %"char[]" { ptr @.str.1, i64 21 }, ptr %x, align 8
  %0 = call ptr @std.io.stdout(), !dbg !39
  ...
  call void @llvm.memcpy.p0.p0.i32(ptr align 8 %x3, ptr align 8 %x1, i32 16, i1 false)
  %2 = load ptr, ptr %out2, align 8
  call void @llvm.memcpy.p0.p0.i32(ptr align 8 %indirectarg, ptr align 8 %x3, i32 16, i1 false)
  %3 = call i64 @std.io.File.write(ptr %retparam, ptr %2, ptr align 8 %indirectarg), !dbg !46
  %not_err = icmp eq i64 %3, 0, !dbg !46
  %4 = call i1 @llvm.expect.i1(i1 %not_err, i1 true), !dbg !46
  br i1 %4, label %after_check, label %assign_optional, !dbg !46

assign_optional:                                  ; preds = %entry
  store i64 %3, ptr %error_var, align 8, !dbg !46
...
noerr_block:                                      ; preds = %after_check
  %5 = load i64, ptr %retparam, align 8, !dbg !46
  store i64 %5, ptr %len, align 8, !dbg !46
  %6 = load ptr, ptr %out, align 8, !dbg !49
  %7 = call i64 @std.io.File.write_byte(ptr %6, i8 10), !dbg !50
  %not_err6 = icmp eq i64 %7, 0, !dbg !50
  %8 = call i1 @llvm.expect.i1(i1 %not_err6, i1 true), !dbg !50
  br i1 %8, label %after_check8, label %assign_optional7, !dbg !50

assign_optional7:                                 ; preds = %noerr_block
  store i64 %7, ptr %error_var5, align 8, !dbg !50
  br label %guard_block9, !dbg !50

after_check8:                                     ; preds = %noerr_block
  br label %noerr_block10, !dbg !50

guard_block9:                                     ; preds = %assign_optional7
  br label %voiderr, !dbg !50

noerr_block10:                                    ; preds = %after_check8
  %9 = load ptr, ptr %out, align 8, !dbg !51
  %10 = call i64 @std.io.File.flush(ptr %9), !dbg !51
  %not_err12 = icmp eq i64 %10, 0, !dbg !51
  %11 = call i1 @llvm.expect.i1(i1 %not_err12, i1 true), !dbg !51
  br i1 %11, label %after_check14, label %assign_optional13, !dbg !51

assign_optional13:                                ; preds = %noerr_block10
  store i64 %10, ptr %error_var11, align 8, !dbg !51
  br label %guard_block15, !dbg !51

after_check14:                                    ; preds = %noerr_block10
  br label %noerr_block16, !dbg !51

guard_block15:                                    ; preds = %assign_optional13
  br label %voiderr, !dbg !51

noerr_block16:                                    ; preds = %after_check14
  %12 = load i64, ptr %len, align 8, !dbg !52
  %add = add i64 %12, 1, !dbg !52
  br label %voiderr, !dbg !45
...
; Function Attrs: nounwind ssp uwtable
define void @game.game_state(i32 %0) #0 !dbg !53 {
entry:
  ...
  call void @llvm.dbg.declare(metadata ptr %s, metadata !56, metadata !DIExpression()), !dbg !57
...
switch.case:                                      ; preds = %switch.entry
  store %"char[]" { ptr @.str.2, i64 10 }, ptr %x, align 8
  %3 = call ptr @std.io.stdout(), !dbg !58
  store ptr %3, ptr %out, align 8
  call void @llvm.memcpy.p0.p0.i32(ptr align 8 %x1, ptr align 8 %x, i32 16, i1 false)
  call void @llvm.dbg.declare(metadata ptr %len, metadata !63, metadata !DIExpression()), !dbg !65
  %4 = load ptr, ptr %out, align 8
  store ptr %4, ptr %out2, align 8
  call void @llvm.memcpy.p0.p0.i32(ptr align 8 %x3, ptr align 8 %x1, i32 16, i1 false)
  %5 = load ptr, ptr %out2, align 8
  call void @llvm.memcpy.p0.p0.i32(ptr align 8 %indirectarg, ptr align 8 %x3, i32 16, i1 false)
  %6 = call i64 @std.io.File.write(ptr %retparam, ptr %5, ptr align 8 %indirectarg), !dbg !67
  %not_err = icmp eq i64 %6, 0, !dbg !67
  %7 = call i1 @llvm.expect.i1(i1 %not_err, i1 true), !dbg !67
  br i1 %7, label %after_check, label %assign_optional, !dbg !67

assign_optional:                                  ; preds = %switch.case
  store i64 %6, ptr %error_var, align 8, !dbg !67
  br label %guard_block, !dbg !67

after_check:                                      ; preds = %switch.case
  br label %noerr_block, !dbg !67

guard_block:                                      ; preds = %assign_optional
  br label %voiderr, !dbg !67

noerr_block:                                      ; preds = %after_check
  %8 = load i64, ptr %retparam, align 8, !dbg !67
  store i64 %8, ptr %len, align 8, !dbg !67
  %9 = load ptr, ptr %out, align 8, !dbg !70
  %10 = call i64 @std.io.File.write_byte(ptr %9, i8 10), !dbg !71
  %not_err6 = icmp eq i64 %10, 0, !dbg !71
  %11 = call i1 @llvm.expect.i1(i1 %not_err6, i1 true), !dbg !71
  br i1 %11, label %after_check8, label %assign_optional7, !dbg !71

assign_optional7:                                 ; preds = %noerr_block
  store i64 %10, ptr %error_var5, align 8, !dbg !71
  br label %guard_block9, !dbg !71

after_check8:                                     ; preds = %noerr_block
  br label %noerr_block10, !dbg !71

guard_block9:                                     ; preds = %assign_optional7
  br label %voiderr, !dbg !71

noerr_block10:                                    ; preds = %after_check8
  %12 = load ptr, ptr %out, align 8, !dbg !72
  %13 = call i64 @std.io.File.flush(ptr %12), !dbg !72
  %not_err12 = icmp eq i64 %13, 0, !dbg !72
  %14 = call i1 @llvm.expect.i1(i1 %not_err12, i1 true), !dbg !72
  br i1 %14, label %after_check14, label %assign_optional13, !dbg !72

assign_optional13:                                ; preds = %noerr_block10
  store i64 %13, ptr %error_var11, align 8, !dbg !72
  br label %guard_block15, !dbg !72

after_check14:                                    ; preds = %noerr_block10
  br label %noerr_block16, !dbg !72

guard_block15:                                    ; preds = %assign_optional13
  br label %voiderr, !dbg !72

noerr_block16:                                    ; preds = %after_check14
  %15 = load i64, ptr %len, align 8, !dbg !73
  %add = add i64 %15, 1, !dbg !73
  br label %voiderr, !dbg !66

voiderr:                                          ; preds = %noerr_block16, %guard_block15, %guard_block9, %guard_block
  call void @game.handle_events(), !dbg !74
  br label %switch.exit, !dbg !74

switch.case17:                                    ; preds = %switch.entry
  store %"char[]" { ptr @.str.3, i64 11 }, ptr %x18, align 8
  %16 = call ptr @std.io.stdout(), !dbg !75
  store ptr %16, ptr %out19, align 8
  call void @llvm.memcpy.p0.p0.i32(ptr align 8 %x20, ptr align 8 %x18, i32 16, i1 false)
  call void @llvm.dbg.declare(metadata ptr %len21, metadata !79, metadata !DIExpression()), !dbg !81
  ...
  %19 = call i64 @std.io.File.write(ptr %retparam26, ptr %18, ptr align 8 %indirectarg27), !dbg !83
  %not_err28 = icmp eq i64 %19, 0, !dbg !83
  %20 = call i1 @llvm.expect.i1(i1 %not_err28, i1 true), !dbg !83
  br i1 %20, label %after_check30, label %assign_optional29, !dbg !83

assign_optional29:                                ; preds = %switch.case17
  store i64 %19, ptr %error_var22, align 8, !dbg !83
  br label %guard_block31, !dbg !83

after_check30:                                    ; preds = %switch.case17
  br label %noerr_block32, !dbg !83

guard_block31:                                    ; preds = %assign_optional29
  br label %voiderr46, !dbg !83

noerr_block32:                                    ; preds = %after_check30
  %21 = load i64, ptr %retparam26, align 8, !dbg !83
  store i64 %21, ptr %len21, align 8, !dbg !83
  %22 = load ptr, ptr %out19, align 8, !dbg !86
  %23 = call i64 @std.io.File.write_byte(ptr %22, i8 10), !dbg !87
  %not_err34 = icmp eq i64 %23, 0, !dbg !87
  %24 = call i1 @llvm.expect.i1(i1 %not_err34, i1 true), !dbg !87
  br i1 %24, label %after_check36, label %assign_optional35, !dbg !87

assign_optional35:                                ; preds = %noerr_block32
  store i64 %23, ptr %error_var33, align 8, !dbg !87
  br label %guard_block37, !dbg !87

after_check36:                                    ; preds = %noerr_block32
  br label %noerr_block38, !dbg !87

guard_block37:                                    ; preds = %assign_optional35
  br label %voiderr46, !dbg !87

noerr_block38:                                    ; preds = %after_check36
  %25 = load ptr, ptr %out19, align 8, !dbg !88
  %26 = call i64 @std.io.File.flush(ptr %25), !dbg !88
  %not_err40 = icmp eq i64 %26, 0, !dbg !88
  %27 = call i1 @llvm.expect.i1(i1 %not_err40, i1 true), !dbg !88
  br i1 %27, label %after_check42, label %assign_optional41, !dbg !88

assign_optional41:                                ; preds = %noerr_block38
  store i64 %26, ptr %error_var39, align 8, !dbg !88
  br label %guard_block43, !dbg !88

after_check42:                                    ; preds = %noerr_block38
  br label %noerr_block44, !dbg !88

guard_block43:                                    ; preds = %assign_optional41
  br label %voiderr46, !dbg !88

noerr_block44:                                    ; preds = %after_check42
  %28 = load i64, ptr %len21, align 8, !dbg !89
  %add45 = add i64 %28, 1, !dbg !89
  br label %voiderr46, !dbg !82
...
switch.case47:                                    ; preds = %switch.entry
  store %"char[]" { ptr @.str.4, i64 10 }, ptr %x48, align 8
  %29 = call ptr @std.io.stdout(), !dbg !90
  store ptr %29, ptr %out49, align 8
  call void @llvm.memcpy.p0.p0.i32(ptr align 8 %x50, ptr align 8 %x48, i32 16, i1 false)
  call void @llvm.dbg.declare(metadata ptr %len51, metadata !94, metadata !DIExpression()), !dbg !96
  ...
  %32 = call i64 @std.io.File.write(ptr %retparam56, ptr %31, ptr align 8 %indirectarg57), !dbg !98
  %not_err58 = icmp eq i64 %32, 0, !dbg !98
  %33 = call i1 @llvm.expect.i1(i1 %not_err58, i1 true), !dbg !98
  br i1 %33, label %after_check60, label %assign_optional59, !dbg !98

assign_optional59:                                ; preds = %switch.case47
  store i64 %32, ptr %error_var52, align 8, !dbg !98
  br label %guard_block61, !dbg !98

after_check60:                                    ; preds = %switch.case47
  br label %noerr_block62, !dbg !98

guard_block61:                                    ; preds = %assign_optional59
  br label %voiderr76, !dbg !98

noerr_block62:                                    ; preds = %after_check60
  %34 = load i64, ptr %retparam56, align 8, !dbg !98
  store i64 %34, ptr %len51, align 8, !dbg !98
  %35 = load ptr, ptr %out49, align 8, !dbg !101
  %36 = call i64 @std.io.File.write_byte(ptr %35, i8 10), !dbg !102
  %not_err64 = icmp eq i64 %36, 0, !dbg !102
  %37 = call i1 @llvm.expect.i1(i1 %not_err64, i1 true), !dbg !102
  br i1 %37, label %after_check66, label %assign_optional65, !dbg !102

assign_optional65:                                ; preds = %noerr_block62
  store i64 %36, ptr %error_var63, align 8, !dbg !102
  br label %guard_block67, !dbg !102

after_check66:                                    ; preds = %noerr_block62
  br label %noerr_block68, !dbg !102

guard_block67:                                    ; preds = %assign_optional65
  br label %voiderr76, !dbg !102

noerr_block68:                                    ; preds = %after_check66
  %38 = load ptr, ptr %out49, align 8, !dbg !103
  %39 = call i64 @std.io.File.flush(ptr %38), !dbg !103
  %not_err70 = icmp eq i64 %39, 0, !dbg !103
  %40 = call i1 @llvm.expect.i1(i1 %not_err70, i1 true), !dbg !103
  br i1 %40, label %after_check72, label %assign_optional71, !dbg !103

assign_optional71:                                ; preds = %noerr_block68
  store i64 %39, ptr %error_var69, align 8, !dbg !103
  br label %guard_block73, !dbg !103

after_check72:                                    ; preds = %noerr_block68
  br label %noerr_block74, !dbg !103

guard_block73:                                    ; preds = %assign_optional71
  br label %voiderr76, !dbg !103

noerr_block74:                                    ; preds = %after_check72
  %41 = load i64, ptr %len51, align 8, !dbg !104
  %add75 = add i64 %41, 1, !dbg !104
  br label %voiderr76, !dbg !97
...
switch.case77:                                    ; preds = %switch.entry
  store %"char[]" { ptr @.str.5, i64 14 }, ptr %x78, align 8
  %42 = call ptr @std.io.stdout(), !dbg !105
  store ptr %42, ptr %out79, align 8
  call void @llvm.memcpy.p0.p0.i32(ptr align 8 %x80, ptr align 8 %x78, i32 16, i1 false)
  call void @llvm.dbg.declare(metadata ptr %len81, metadata !109, metadata !DIExpression()), !dbg !111
  ...
  %45 = call i64 @std.io.File.write(ptr %retparam86, ptr %44, ptr align 8 %indirectarg87), !dbg !113
  %not_err88 = icmp eq i64 %45, 0, !dbg !113
  %46 = call i1 @llvm.expect.i1(i1 %not_err88, i1 true), !dbg !113
  br i1 %46, label %after_check90, label %assign_optional89, !dbg !113

assign_optional89:                                ; preds = %switch.case77
  store i64 %45, ptr %error_var82, align 8, !dbg !113
  br label %guard_block91, !dbg !113

after_check90:                                    ; preds = %switch.case77
  br label %noerr_block92, !dbg !113

guard_block91:                                    ; preds = %assign_optional89
  br label %voiderr106, !dbg !113

noerr_block92:                                    ; preds = %after_check90
  %47 = load i64, ptr %retparam86, align 8, !dbg !113
  store i64 %47, ptr %len81, align 8, !dbg !113
  %48 = load ptr, ptr %out79, align 8, !dbg !116
  %49 = call i64 @std.io.File.write_byte(ptr %48, i8 10), !dbg !117
  %not_err94 = icmp eq i64 %49, 0, !dbg !117
  %50 = call i1 @llvm.expect.i1(i1 %not_err94, i1 true), !dbg !117
  br i1 %50, label %after_check96, label %assign_optional95, !dbg !117

assign_optional95:                                ; preds = %noerr_block92
  store i64 %49, ptr %error_var93, align 8, !dbg !117
  br label %guard_block97, !dbg !117

after_check96:                                    ; preds = %noerr_block92
  br label %noerr_block98, !dbg !117

guard_block97:                                    ; preds = %assign_optional95
  br label %voiderr106, !dbg !117

noerr_block98:                                    ; preds = %after_check96
  %51 = load ptr, ptr %out79, align 8, !dbg !118
  %52 = call i64 @std.io.File.flush(ptr %51), !dbg !118
  %not_err100 = icmp eq i64 %52, 0, !dbg !118
  %53 = call i1 @llvm.expect.i1(i1 %not_err100, i1 true), !dbg !118
  br i1 %53, label %after_check102, label %assign_optional101, !dbg !118

assign_optional101:                               ; preds = %noerr_block98
  store i64 %52, ptr %error_var99, align 8, !dbg !118
  br label %guard_block103, !dbg !118

after_check102:                                   ; preds = %noerr_block98
  br label %noerr_block104, !dbg !118

guard_block103:                                   ; preds = %assign_optional101
  br label %voiderr106, !dbg !118

noerr_block104:                                   ; preds = %after_check102
  %54 = load i64, ptr %len81, align 8, !dbg !119
  %add105 = add i64 %54, 1, !dbg !119
  br label %voiderr106, !dbg !112
...
switch.case107:                                   ; preds = %switch.entry
  store %"char[]" { ptr @.str.6, i64 13 }, ptr %x108, align 8
  %55 = call ptr @std.io.stdout(), !dbg !120
  store ptr %55, ptr %out109, align 8
  call void @llvm.memcpy.p0.p0.i32(ptr align 8 %x110, ptr align 8 %x108, i32 16, i1 false)
  call void @llvm.dbg.declare(metadata ptr %len111, metadata !124, metadata !DIExpression()), !dbg !126
  ...
  %58 = call i64 @std.io.File.write(ptr %retparam116, ptr %57, ptr align 8 %indirectarg117), !dbg !128
  %not_err118 = icmp eq i64 %58, 0, !dbg !128
  %59 = call i1 @llvm.expect.i1(i1 %not_err118, i1 true), !dbg !128
  br i1 %59, label %after_check120, label %assign_optional119, !dbg !128

assign_optional119:                               ; preds = %switch.case107
  store i64 %58, ptr %error_var112, align 8, !dbg !128
  br label %guard_block121, !dbg !128

after_check120:                                   ; preds = %switch.case107
  br label %noerr_block122, !dbg !128

guard_block121:                                   ; preds = %assign_optional119
  br label %voiderr136, !dbg !128

noerr_block122:                                   ; preds = %after_check120
  %60 = load i64, ptr %retparam116, align 8, !dbg !128
  store i64 %60, ptr %len111, align 8, !dbg !128
  %61 = load ptr, ptr %out109, align 8, !dbg !131
  %62 = call i64 @std.io.File.write_byte(ptr %61, i8 10), !dbg !132
  %not_err124 = icmp eq i64 %62, 0, !dbg !132
  %63 = call i1 @llvm.expect.i1(i1 %not_err124, i1 true), !dbg !132
  br i1 %63, label %after_check126, label %assign_optional125, !dbg !132

assign_optional125:                               ; preds = %noerr_block122
  store i64 %62, ptr %error_var123, align 8, !dbg !132
  br label %guard_block127, !dbg !132

after_check126:                                   ; preds = %noerr_block122
  br label %noerr_block128, !dbg !132

guard_block127:                                   ; preds = %assign_optional125
  br label %voiderr136, !dbg !132

noerr_block128:                                   ; preds = %after_check126
  %64 = load ptr, ptr %out109, align 8, !dbg !133
  %65 = call i64 @std.io.File.flush(ptr %64), !dbg !133
  %not_err130 = icmp eq i64 %65, 0, !dbg !133
  %66 = call i1 @llvm.expect.i1(i1 %not_err130, i1 true), !dbg !133
  br i1 %66, label %after_check132, label %assign_optional131, !dbg !133

assign_optional131:                               ; preds = %noerr_block128
  store i64 %65, ptr %error_var129, align 8, !dbg !133
  br label %guard_block133, !dbg !133

after_check132:                                   ; preds = %noerr_block128
  br label %noerr_block134, !dbg !133

guard_block133:                                   ; preds = %assign_optional131
  br label %voiderr136, !dbg !133

noerr_block134:                                   ; preds = %after_check132
  %67 = load i64, ptr %len111, align 8, !dbg !134
  %add135 = add i64 %67, 1, !dbg !134
  br label %voiderr136, !dbg !127
...
switch.case137:                                   ; preds = %switch.entry
  store %"char[]" { ptr @.str.7, i64 11 }, ptr %x138, align 8
  %68 = call ptr @std.io.stdout(), !dbg !135
  store ptr %68, ptr %out139, align 8
  call void @llvm.memcpy.p0.p0.i32(ptr align 8 %x140, ptr align 8 %x138, i32 16, i1 false)
  call void @llvm.dbg.declare(metadata ptr %len141, metadata !139, metadata !DIExpression()), !dbg !141
  ...
  %71 = call i64 @std.io.File.write(ptr %retparam146, ptr %70, ptr align 8 %indirectarg147), !dbg !143
  %not_err148 = icmp eq i64 %71, 0, !dbg !143
  %72 = call i1 @llvm.expect.i1(i1 %not_err148, i1 true), !dbg !143
  br i1 %72, label %after_check150, label %assign_optional149, !dbg !143

assign_optional149:                               ; preds = %switch.case137
  store i64 %71, ptr %error_var142, align 8, !dbg !143
  br label %guard_block151, !dbg !143

after_check150:                                   ; preds = %switch.case137
  br label %noerr_block152, !dbg !143

guard_block151:                                   ; preds = %assign_optional149
  br label %voiderr166, !dbg !143

noerr_block152:                                   ; preds = %after_check150
  %73 = load i64, ptr %retparam146, align 8, !dbg !143
  store i64 %73, ptr %len141, align 8, !dbg !143
  %74 = load ptr, ptr %out139, align 8, !dbg !146
  %75 = call i64 @std.io.File.write_byte(ptr %74, i8 10), !dbg !147
  %not_err154 = icmp eq i64 %75, 0, !dbg !147
  %76 = call i1 @llvm.expect.i1(i1 %not_err154, i1 true), !dbg !147
  br i1 %76, label %after_check156, label %assign_optional155, !dbg !147

assign_optional155:                               ; preds = %noerr_block152
  store i64 %75, ptr %error_var153, align 8, !dbg !147
  br label %guard_block157, !dbg !147

after_check156:                                   ; preds = %noerr_block152
  br label %noerr_block158, !dbg !147

guard_block157:                                   ; preds = %assign_optional155
  br label %voiderr166, !dbg !147

noerr_block158:                                   ; preds = %after_check156
  %77 = load ptr, ptr %out139, align 8, !dbg !148
  %78 = call i64 @std.io.File.flush(ptr %77), !dbg !148
  %not_err160 = icmp eq i64 %78, 0, !dbg !148
  %79 = call i1 @llvm.expect.i1(i1 %not_err160, i1 true), !dbg !148
  br i1 %79, label %after_check162, label %assign_optional161, !dbg !148

assign_optional161:                               ; preds = %noerr_block158
  store i64 %78, ptr %error_var159, align 8, !dbg !148
  br label %guard_block163, !dbg !148

after_check162:                                   ; preds = %noerr_block158
  br label %noerr_block164, !dbg !148

guard_block163:                                   ; preds = %assign_optional161
  br label %voiderr166, !dbg !148

noerr_block164:                                   ; preds = %after_check162
  %80 = load i64, ptr %len141, align 8, !dbg !149
  %add165 = add i64 %80, 1, !dbg !149
  br label %voiderr166, !dbg !142

voiderr166:                                       ; preds = %noerr_block164, %guard_block163, %guard_block157, %guard_block151
  br label %switch.exit, !dbg !142
...
!5 = !{!6}
!6 = !DICompositeType(tag: DW_TAG_enumeration_type, name: "GameScreen", scope: !4, file: !4, line: 15, baseType: !7, size: 32, align: 32, elements: !8)
...
!17 = !{null}
!18 = !DILocation(line: 6, column: 13, scope: !15)
...
!23 = distinct !DILexicalBlock(scope: !15, file: !4, line: 6, column: 41)
...
!38 = distinct !DISubprogram(name: "handle_physics", linkageName: "game.handle_physics", scope: !4, file: !4, line: 11, type: !16, scopeLine: 11, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !3)
!39 = !DILocation(line: 194, column: 20, scope: !40, inlinedAt: !41)
!40 = distinct !DISubprogram(name: "printn", linkageName: "printn", scope: !21, file: !21, line: 192, scopeLine: 192, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !3)
!41 = !DILocation(line: 12, column: 9, scope: !38)
!42 = !DILocalVariable(name: "len", scope: !43, file: !4, line: 168, type: !27, align: 8)
!43 = distinct !DISubprogram(name: "fprintn", linkageName: "fprintn", scope: !21, file: !21, line: 166, scopeLine: 166, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !3, retainedNodes: !26)
!44 = !DILocation(line: 168, column: 6, scope: !43, inlinedAt: !45)
!45 = !DILocation(line: 194, column: 3, scope: !40, inlinedAt: !41)
!46 = !DILocation(line: 118, column: 24, scope: !47, inlinedAt: !48)
!47 = distinct !DISubprogram(name: "fprint", linkageName: "fprint", scope: !21, file: !21, line: 114, scopeLine: 114, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !3)
!48 = !DILocation(line: 168, column: 12, scope: !43, inlinedAt: !45)
!49 = !DILocation(line: 169, column: 17, scope: !43, inlinedAt: !45)
!50 = !DILocation(line: 169, column: 2, scope: !43, inlinedAt: !45)
!51 = !DILocation(line: 174, column: 4, scope: !43, inlinedAt: !45)
!52 = !DILocation(line: 176, column: 9, scope: !43, inlinedAt: !45)
!53 = distinct !DISubprogram(name: "game_state", linkageName: "game.game_state", scope: !4, file: !4, line: 24, type: !54, scopeLine: 24, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !3, retainedNodes: !26)
!54 = !DISubroutineType(types: !55)
!55 = !{null, !6}
!56 = !DILocalVariable(name: "s", arg: 1, scope: !53, file: !4, line: 24, type: !6)
!57 = !DILocation(line: 24, column: 31, scope: !53)
!58 = !DILocation(line: 194, column: 20, scope: !59, inlinedAt: !60)
!59 = distinct !DISubprogram(name: "printn", linkageName: "printn", scope: !21, file: !21, line: 192, scopeLine: 192, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !3)
!60 = !DILocation(line: 28, column: 17, scope: !61)
!61 = distinct !DILexicalBlock(scope: !62, file: !4, line: 28, column: 13)
!62 = distinct !DILexicalBlock(scope: !53, file: !4, line: 25, column: 5)
!63 = !DILocalVariable(name: "len", scope: !64, file: !4, line: 168, type: !27, align: 8)
!64 = distinct !DISubprogram(name: "fprintn", linkageName: "fprintn", scope: !21, file: !21, line: 166, scopeLine: 166, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !3, retainedNodes: !26)
!65 = !DILocation(line: 168, column: 6, scope: !64, inlinedAt: !66)
!66 = !DILocation(line: 194, column: 3, scope: !59, inlinedAt: !60)
!67 = !DILocation(line: 118, column: 24, scope: !68, inlinedAt: !69)
!68 = distinct !DISubprogram(name: "fprint", linkageName: "fprint", scope: !21, file: !21, line: 114, scopeLine: 114, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !3)
!69 = !DILocation(line: 168, column: 12, scope: !64, inlinedAt: !66)
!70 = !DILocation(line: 169, column: 17, scope: !64, inlinedAt: !66)
!71 = !DILocation(line: 169, column: 2, scope: !64, inlinedAt: !66)
!72 = !DILocation(line: 174, column: 4, scope: !64, inlinedAt: !66)
!73 = !DILocation(line: 176, column: 9, scope: !64, inlinedAt: !66)
!74 = !DILocation(line: 29, column: 13, scope: !61)
...
!78 = distinct !DILexicalBlock(scope: !62, file: !4, line: 32, column: 13)
...
!93 = distinct !DILexicalBlock(scope: !62, file: !4, line: 35, column: 13)
...
!108 = distinct !DILexicalBlock(scope: !62, file: !4, line: 38, column: 13)
...
!123 = distinct !DILexicalBlock(scope: !62, file: !4, line: 41, column: 13)
...
!135 = !DILocation(line: 194, column: 20, scope: !136, inlinedAt: !137)
!136 = distinct !DISubprogram(name: "printn", linkageName: "printn", scope: !21, file: !21, line: 192, scopeLine: 192, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !3)
!137 = !DILocation(line: 44, column: 17, scope: !138)
!138 = distinct !DILexicalBlock(scope: !62, file: !4, line: 44, column: 13)
!139 = !DILocalVariable(name: "len", scope: !140, file: !4, line: 168, type: !27, align: 8)
!140 = distinct !DISubprogram(name: "fprintn", linkageName: "fprintn", scope: !21, file: !21, line: 166, scopeLine: 166, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !3, retainedNodes: !26)
!141 = !DILocation(line: 168, column: 6, scope: !140, inlinedAt: !142)
!142 = !DILocation(line: 194, column: 3, scope: !136, inlinedAt: !137)
!143 = !DILocation(line: 118, column: 24, scope: !144, inlinedAt: !145)
!144 = distinct !DISubprogram(name: "fprint", linkageName: "fprint", scope: !21, file: !21, line: 114, scopeLine: 114, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !3)
!145 = !DILocation(line: 168, column: 12, scope: !140, inlinedAt: !142)
!146 = !DILocation(line: 169, column: 17, scope: !140, inlinedAt: !142)
!147 = !DILocation(line: 169, column: 2, scope: !140, inlinedAt: !142)
!148 = !DILocation(line: 174, column: 4, scope: !140, inlinedAt: !142)
!149 = !DILocation(line: 176, column: 9, scope: !140, inlinedAt: !142)
